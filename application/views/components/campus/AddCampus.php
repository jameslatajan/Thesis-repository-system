      ...
      <div class="card-body">
        <form action="<?php echo base_url("addcampus/submit") ?>" method="POST">
          <div class="mb-3">
            ...
            <input type="text" name="campus_name" class="form-control " id="">
            <small class="text-danger"><?php echo form_error('campus_name'); ?></small>
          </div>
          <div class="mb-3">
            <label for="" class="form-label">Campus Director</label>
            <input type="text" name="campus_director" class="form-control " id="">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="ceit_dean" class="form-control " id="">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cas_dean" class="form-control " id="">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cte_dean" class="form-control " id="">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cot_dean" class="form-control   " id="">
