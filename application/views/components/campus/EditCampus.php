      ...
      <div class="card-body">
        <form action="<?php echo base_url("campuses/update/".$campus['campus_id'])?>" method="POST">
          <div class="mb-3">
            ...
            <input type="text" name="campus_name" class="form-control text-uppercase" id="" value="<?= $campus['campus_name']?>">
            <small class="text-danger"><?php echo form_error('campus_name'); ?></small>
          </div>
          <div class="mb-3">
            <label for="" class="form-label">Campus Director</label>
            <input type="text" name="campus_director" class="form-control text-uppercase" id="" value="<?= $campus['campus_director']?>">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="ceit_dean" class="form-control text-uppercase" id="" value="<?= $campus['ceit_dean']?>">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cas_dean" class="form-control text-uppercase" id="" value="<?= $campus['cas_dean']?>">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cte_dean" class="form-control text-uppercase" id="" value="<?= $campus['cte_dean']?>" >
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="cot_dean" class="form-control text-uppercase text-uppercase " id="" value="<?= $campus['cot_dean']?>">
