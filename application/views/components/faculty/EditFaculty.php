      ...
      <div class="card-body">
        <form action="<?php echo base_url('updatefaculty/'.$faculty->faculty_id)?>" method="POST">
          ...
          <div class="row">
            <div class="col-12">
              <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control text-uppercase" id="" value="<?php echo $faculty->name?>">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="date" name="birth_date" class="form-control text-uppercase" id="" value="<?php echo $faculty->birth_date?>">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="address" class="form-control text-uppercase" id="" value="<?php echo $faculty->address?>">
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="position" class="form-control text-uppercase" id="" value="<?php echo $faculty->position?>">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" name="faculty_name" class="form-control text-uppercase" id="" value="<?php echo $faculty->faculty_name?>">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="contact_no" class="form-control text-uppercase" id="" value="<?php echo $faculty->contact_no?>">
