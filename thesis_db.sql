...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 08:47 AM
...
(101, 'Surigao City ', 'ceit', 'Reyna, Alma Christie C.', 'Female', '1976-04-15', 'None', 'None', 'Associate Professor II Program Chair', 'None', '', 0, '2022-12-05 14:48:40.406947'),
...
(134, 'Malimono ', 'cte', 'Agdana, Francis Mervin L.', 'Female', '1982-10-28', 'None', 'None', 'Assistant Professor IV Planning Officer - Designate', 'None', '', 0, '2022-12-09 09:36:16.410037'),
(135, 'Malimono ', 'cas', 'Olidan, Melba C.', 'Female', '1994-09-25', 'None', 'None', 'Instructor 1 - Temporary SSG Adviser', 'None', '', 0, '2022-12-09 09:38:28.513369'),
(136, 'Malimono ', 'cte', 'Pagalan, Abelano P.', 'Male', '1980-09-25', 'None', 'None', 'Instructor 1', 'None', '', 0, '2022-12-09 09:40:48.231525'),
(137, 'Malimono ', 'cte', 'Guiral, Froilan Jay E.', 'Male', '1982-06-22', 'None', 'None', 'Associate Professor II', 'None', '', 0, '2022-12-09 09:44:00.302864'),
(138, 'Malimono ', 'cte', 'Dumanig, Abegail P', 'Female', '1981-11-20', 'None', 'None', 'Instructor III IGP Coordinator', 'None', '', 0, '2022-12-09 09:44:45.713243'),
(139, 'Malimono ', 'cot', 'Escobido, Hansen Rose S.', 'Female', '1994-07-11', 'None', 'None', 'Instructor I', 'None', '', 0, '2022-12-09 09:45:48.264179'),
(140, 'Malimono ', 'cot', 'Dela Peña, Jayson D.', 'Male', '1987-05-27', 'None', 'None', 'Instructor 1 - Temporary', 'None', '', 0, '2022-12-09 09:46:38.970793'),
(141, 'Del Carmen ', 'cot', 'Segales, Sheena Jane B.', 'Female', '1995-12-10', 'None', 'None', 'Instructor I - Temporary', 'None', '', 0, '2022-12-09 09:53:25.709097');
...
(75, 57, 'Surigao City ', 'cas', 'None', 'Effects of Greywater on Seed Germination, Survival, and Early Growth Acceptance Letter', 'Danilyn L. Odtojan', 'Acceptance Letter', '2021-08-09', '2c7ac770a7bb2dcfdd097bbc462ef772.jpg', '', 0, '2022-12-07'),
...
(84, 57, 'Surigao City ', 'cas', 'None', 'Carrying Capacity Assessment of Looc Pebble Beach in Surigao City, towards its Sustanability Letter of Acceptance', 'Medielyn M. Odtojan', ' None', '2021-11-22', '760aa40436381b36cbac421caf2fd18d.jpg', '', 0, '2022-12-07'),
...
(88, 71, 'Surigao City ', 'cte', 'None', 'Knowledge and Utilization of Traditional Medicine Among the Communities of Bucas Grande Island Letter of Acceptance', 'Muricio S. Adlaon and Melicia P. Elandag', ' ICMATSD-21', '2021-11-22', '497dd91cbed681604715cb2749d6b56b.jpg', '', 0, '2022-12-07'),
(89, 71, 'Surigao City ', 'cte', 'None', 'Learners Attitude Towards Science on the Use of Modular Learning Letter of Acceptance', 'Mauricio S. Adlaon and Jean Lucillie F. Espejon', ' ICMATSD-21 IFERP', '2021-11-22', '0a76a53e26e61c2ca961d8d8f6ec34db.jpg', '', 0, '2022-12-07'),
...
(99, 101, 'Surigao City ', 'ceit', 'None', 'SCVAX: A Solution to Nationwide Vaccination Management Information System', 'Alma Chritie Reyna', 'ICITE 2022', '2022-09-16', 'afbd3f7a7cc78adfa5d4be38d0ea5b5a.pdf', '', 0, '2022-12-07'),
...
(110, 87, 'Surigao City ', 'cte', 'None', 'A Phenomelogical Study of Live Experiences of Pre-service Teacher in Online Practice Teaching', 'Lucille G. Tanguhian', ' None', '2022-01-02', 'f27e9cd88ea9915a995ac674cc365a87.pdf', '', 0, '2022-12-09'),
(111, 112, 'Surigao City ', 'cte', 'None', '2nd International Conference Biodiversity and Climate Change 2021', 'Louella S. Degamon', ' None', '2021-09-23', '4c54ab75dcb6612aa3655db0718063c9.jpg', '', 0, '2022-12-09'),
(112, 87, 'Surigao City ', 'cte', 'None', 'International Research Enthusiast Society Inc Certificate of Recognition', 'Lucille G. Tanguhian', ' None', '2021-11-27', '72ce7eda5adc5598cf9f864f2c98229e.jpg', '', 0, '2022-12-09'),
(113, 87, 'Surigao City ', 'cte', 'None', 'World Conference on Applied Science, Engineering and Technology 2021', 'Lucille G. Tanguhian', ' None', '2021-11-22', '606ca19bffdc2fec36ea9bd124b63a3b.jpg', '', 0, '2022-12-09'),
(114, 112, 'Surigao City ', 'cte', 'None', 'Assestment of Microinvertibrates in Barangay Nabago, Surigao city', 'Madel D. Ramos, Joyce mate L. Delos Reyes, Louella S. Degamon', ' None', '2022-05-24', '19c7585fd4a3479c3532f0ff6c3c7079.pdf', '', 0, '2022-12-09'),
(115, 112, 'Surigao City ', 'cte', 'None', 'Carapace length - weight and carapace width weight relationships of Thalamita crenata from Siargao Islands Phiippines', 'Louella S. Degamon', ' None', '2022-04-28', '03567b67cff181d2f3e07209c7548c73.pdf', '', 0, '2022-12-09'),
(116, 48, 'Surigao City ', 'cas', 'None', 'Edaphic and Physico-chemical Parameters of Mangrove Forest in Brgy Nabago Surigao City', 'Julito M. Cordita Jr, Ana Lena Gajol, and Rosalia L. Hugo', ' None', '2022-10-05', '86507edd6b5090cd6fc2adde333eeacf.pdf', '', 0, '2022-12-09'),
(117, 112, 'Surigao City ', 'cte', 'None', 'MORPHOMETRY AND ALLOMETRY OF THALAMITA CRENATA FROM SIARGAO ', 'Louella S. Degamon', ' None', '2022-05-01', '147ffaffbc77d7c071dddd9c710d7aeb.pdf', '', 0, '2022-12-09'),
(118, 87, 'Surigao City ', 'cte', 'None', 'Narratives of the Lived Experiences of Student during Typhoon Rai (Odett)', 'Lucille G. Tanguhian', ' None', '2022-06-10', 'def52917ca364c8275a6facaeb9ab496.pdf', '', 0, '2022-12-09'),
(119, 47, 'Surigao City ', 'cas', 'None', '3RD INT\'L RESEARCH AND EDUCATION SUMMIT', 'Raymond P. Espanola', ' None', '2022-10-03', '18a42e601bd018eedd6955c7bf998833.pdf', '', 0, '2022-12-09'),
(120, 80, 'Surigao City ', 'cot', 'None', 'Development and Evaluation of Calabash Fruit (Cresentiacujete) Juice Drink', 'Quintina D.Gono, Marilou B. Carnicer, Kenneth Charls E. Ferol, Lucihida M. Docoy', ' This is a descriptive study aimed to develop a fruit juice drink made up of calabash fruit\r\n(Cresentiacujete) and evaluate its acceptability. Survey questionnaire was deployed to 120 respondents using\r\nrandom sampling. Results revealed that the calabash fruit juice is generally acceptable with a mean of 3.42. The\r\nfruit juice was believed as a potential product in the market.', '2020-05-05', '853fbce925a26f082a435717123020bf.pdf', '', 0, '2022-12-09'),
(121, 41, 'Surigao City ', 'cas', 'None', 'MANGROVE ASSESSMENT AND PHYSICOCHEMICAL CHARACTERISTICS OF SOIL AND WATER IN BRGY. BAGUMBAYAN, MUNICIPALITY OF DINAGAT, DINAGAT ISLANDS', 'Eunice Zendy F. Agustin, Flaine S. Semorlan, Aljhun Q. Sumatra, Gheleene S. Buenaflor', ' Threats to mangrove ecosystems in Dinagat Island have led the researchers to study the\r\nspecies composition, community structure and soil and water quality of a natural mangrove\r\nforest in Barangay Bagumbayan, Municipality of Dinagat, Dinagat Island in January 2020.\r\nThree 150-meter transect lines were established perpendicular to a 100-meter baseline along\r\nthe shore. Six (6) species belonging to three (3) families were found: Rhizophora apiculata,\r\nRhizophora mucronata, Rhizophora stylosa, Bruguiera sexangula, Lumnitzera littorea, and\r\nXylocarpus granatum. R. apiculata and R. mucronata consistently had the highest relative\r\ndensities (27.0-27.9%), relative frequency (60%), relative dominance (26.9-33.0%), and\r\nimportance values (133.9-120.9), while X. granatum had the least values among all species.\r\nSpecies diversity was very low (1.68). Mean phosphorus (P) and potassium (K) content of the\r\nsoil were moderately high (6 ppm) and sufficient (1097 ppm), respectively, while mean water\r\npH (7.65) and temperature (25.8OC) were within the normal range according to DENR\r\nstandards. The abundance of Rhizophora species (R. apiculata, R. mucronata, and R. stylosa)\r\nin the study area indicates favorable conditions for their growth over other mangrove species.\r\nRunoff from nearby farms possibly contribute to the high soil phosphorus levels via a river\r\ntraversing the sampling sites. Sustainable agricultural practices such as the use of organic\r\nfertilizers are recommended to minimize the adverse impacts of agriculture on mangrove\r\necosystems. Conservation efforts may focus on naturally adept species in the area, while\r\nfuture studies may include additional environmental parameters especially in areas affected\r\nby pollutants from mining activities.', '2020-05-05', 'dd699bcdd7648f30ce0801b3d26b95b3.pdf', '', 0, '2022-12-09'),
(122, 72, 'Surigao City ', 'cte', 'None', 'Species Composition of Coral Reef Fishesin Nonoc Island, Philippines', 'Manny P.Eviotaand Jerry T. Cuadrado', ' This study aimed to determine the species composition of reef fishes in Nonoc Island,\r\nSurigao City, Philippines. The multiple fishing techniques were conducted in the established\r\n50x50 m quadrats in the three sampling stations of the area in January 2020. It yielded 16\r\nspecies of reef fish fauna from 12 families. All species are native in the Philippines and the\r\nmajority are of Least Concern Status (94%). Chlorurus sordidushas the highest relative\r\nabundance (12%) among the collected species. Station 1 or Brgy. Nonoc has the highest\r\nnumber of taxa (S=16) and the most diverse (H’=2.65) among the three sampling stations. The\r\nNonoc Island still hosts a noteworthy number of reef fish fauna despite the mining activities\r\nthat last for decades and the inadmissible fishing activities by the populace in the area. Hence,\r\nregular monitoring and intensive study are essential to come up with a comprehensive data of\r\nreef fish fauna in the area.', '2020-05-05', 'b455d8255ae22d93181ddb7076098169.pdf', '', 0, '2022-12-09'),
(123, 48, 'Surigao City ', 'cas', 'None', 'Fluctuation Dynamics on the Biophysico-Chemical Characteristics and Water Quality Evaluation of Lake Mainit, Philippines', 'Evangeline P. Sabejon1 , Rosalia L. Hugo1 , Jerry B. Manongas1 , Joan Cristine Libot2 , Cara Jane Matabillas2 , Carlos H. Donoso3 , Gregorio Z. Gamboa, Jr3 ,Joycelyn C. Jumawan2 , Rey Y. Capangpangan4,5', ' This study presents the seasonal data on the dynamics of the water quality in Lake Mainit. It was\r\ndesigned to evaluate the temporal variation of the biophysico-chemical parameters from eight\r\nsampling stations from the selected sites around Lake Mainit. Different physico-chemical\r\nparameters were investigated such as pH, temperature, conductivity, Oxidation Reduction\r\nPotential (ORP), salinity, Dissolved Oxygen (DO), Biological Oxygen Demand (BOD), Total\r\nDissolved Solids (TDS), Total Suspended Solids (TSS), sulfate, phosphate, nitrates, and cyanide.\r\nLikewise, biological parameters, fecal coliform (FC) and total coliform (TC) were also analyzed.\r\nThe obtained results were compared with the standards set by the local agency, e.g. Department of\r\nEnvironment and Natural Resources (DENR) Administrative Order 2016-08. The mean values of\r\nthe different water quality parameters across sampling periods in all sampling stations are\r\nenumerated as follows: pH (7.61), temperature (29.4 oC), conductivity (0.153 S/cm), ORP (284.5\r\nmV), salinity (0.073 ppt), turbidity (15.46 NTU), chlorides (69.5 mg/L), hardness (158.7 mg/L),\r\nDO (12.45 mg/L), TDS (0.0955 mg/L), TSS (0.031 mg/L), SO4 (489.4 mg/L), PO4 (5.38 mg/L),\r\nNO3 (29.3 mg/L), Free CN (0.027 mg/L), TC (3116.7 MPN/100 mL) and FC (1078.8 MPN/100\r\nmL). Results have shown that significant variation across sampling periods were observed for the\r\nparameters turbidity, DO, sulfate, phosphate, TC, and FC. Also, the mean values of these\r\nparameters exceeded the set standards, while other parameters are all within the acceptable limits.\r\nCluster Analysis showed three major cluster groups with significant linkage distance while\r\nPrincipal Component Analysis (PCA) revealed that there are five (5) principal components which\r\nrepresents a total variance of 71.04%. Overall, the water from Lake Mainit was found to be in a\r\nsafe quality based on the acceptable standard value, and the lake can still be considered eutrophic.', '2020-05-05', '36d57404310c4a0976e8f4d209beed02.pdf', '', 0, '2022-12-09'),
(125, 104, 'Surigao City ', 'ceit', 'None', 'Power Spectral Density Analysis of Subsurface Electromagnetic Wave (EM) Radar Implemented in USRP 2932', 'Vrian Jay V. Ylaya', ' This paper presents detection buried objects such as metal,\r\nplastic, and water using power spectral density analysis\r\nimplemented in software-defined radio USRP 2932. Each of\r\nthe objects is buried in sandy soil with varying distances and\r\ncapture every power spectral density (PSD) value. The\r\nobtained PSD of each material decreases as the depth\r\nincreases, and each material has a unique value of power\r\nspectral density (PSD), as shown by the results of\r\nexperiments. Thus, subsurface electromagnetic (EM) radar\r\ndetection is possible from the power spectral density analysis\r\nof reflected signals using simple pulse position modulation\r\n(PPM) implemented in software-defined radio.', '2020-05-05', 'cd3c237b781f609d64190c85d1262251.pdf', '', 0, '2022-12-09');
...
--
ALTER TABLE `faculty_tb`
  MODIFY `faculty_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;

--
-- AUTO_INCREMENT for table `files_tb`
--
ALTER TABLE `files_tb`
  MODIFY `file_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
COMMIT;
